...
constructor(@inject(TOKENS.TrainerRepository) private trainerRepository:ITrainerRepository,@inject(TOKENS.OtpService) private otpService:IOtpService ,@inject(TOKENS.TokenService) private tokenService:ITokenService)
{
