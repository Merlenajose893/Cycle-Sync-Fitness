...
export const useRecipe = () => {
        ...
        async (
            ...
            try {
                ...
                if (axios.isAxiosError(err)) {
                    ...
                    setError(RECIPE_MESSAGES.FETCH_UNEXPECTED);
                }
            } finally {
                setLoading(false);
            }
        ...
        async (
            ...
            try {
                ...
                if (axios.isAxiosError(err)) {
                    ...
                    setError(RECIPE_MESSAGES.SEARCH_UNEXPECTED);
                }
            } finally {
                setLoading(false);
            }
        ...
        async (id: string): Promise<Recipe | undefined> => {
            try {
                ...
                if (axios.isAxiosError(err)) {
                    ...
                    setError(RECIPE_MESSAGES.FETCH_BY_ID_UNEXPECTED);
                }
            } finally {
                setLoading(false);
            }
        ...
        async (
            ...
            try {
                ...
                if (axios.isAxiosError(err)) {
                    ...
                    setError(RECIPE_MESSAGES.CREATE_UNEXPECTED);
                }
                return false;
            } finally {
                setLoading(false);
    ...
    const updateRecipe = useCallback(
        async (
            ...
            try {
                ...
                await recipeService.updateRecipe(id, requestData);
                return true;
            } catch (err: unknown) {
                if (axios.isAxiosError(err)) {
                    setError(
                    ...
                    setError(RECIPE_MESSAGES.UPDATE_UNEXPECTED);
                }
                return false;
            } finally {
                setLoading(false);
        ...
        async (id: string): Promise<boolean> => {
            try {
                ...
                if (axios.isAxiosError(err)) {
                    ...
                    setError(RECIPE_MESSAGES.DELETE_UNEXPECTED);
                }
                return false;
            } finally {
                setLoading(false);
        ...
        async (id: string): Promise<boolean> => {
            try {
                ...
                if (axios.isAxiosError(err)) {
                    ...
                    setError(RECIPE_MESSAGES.FAVORITE_UNEXPECTED);
                }
                return false;
            } finally {
                setLoading(false);
    ...
    const addReview = useCallback(
        async (id: string, payload: ReviewPayload): Promise<boolean> => {
            try {
                setLoading(true);
                setError(null);

                await recipeService.addReview(id, payload);
                return true;
            } catch (err: unknown) {
                if (axios.isAxiosError(err)) {
                    setError(
                    ...
                    setError(RECIPE_MESSAGES.REVIEW_UNEXPECTED);
                }
                return false;
            } finally {
                setLoading(false);
