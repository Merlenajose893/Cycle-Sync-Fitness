...
>>>>>>> 081b12d (changes)
            <div className="auth-container" style={{ justifyContent: 'center' }}>
                ...
                <div className="auth-brand" style={{ justifyContent: 'center', marginBottom: '40px' }}>
                    <div className="auth-logo" style={{ background: 'var(--accent-purple)', width: '48px', height: '48px', fontSize: '1.4rem' }}>C</div>
...
>>>>>>> 081b12d (changes)
            ...
            <div className="auth-side" style={{
                ...
                <div className="auth-side-content" style={{ textAlign: 'center' }}>
                    ...
                    <h2 style={{ fontSize: '2rem', fontWeight: '800', marginBottom: '16px' }}>Control Center</h2>
