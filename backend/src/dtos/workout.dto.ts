import type { CyclePhase, WorkoutCategory,WorkoutDifficulty,WorkoutGoal, WorkoutSource } from "../constants/workout.ts";
import type { IWorkoutProgramDay } from "../models/WorkoutProgram.ts";
