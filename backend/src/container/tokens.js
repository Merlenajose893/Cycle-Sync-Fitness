export const TOKENS = {
    ...
    ICycleLogRepository: Symbol.for("ICycleLogRepository"),
    IDailyHealthLogRepository: Symbol.for("IDailyHealthLogRepository"),
    IHealthMilestoneRepository: Symbol.for("IHealthMilestoneRepository"),
    ICycleLogService: Symbol.for("ICycleLogService"),
    ICyclePredictionService: Symbol.for("ICyclePredictionService"),
    IDailyHealthLogService: Symbol.for("IDailyHealthLogService"),
    IHealthMilestoneService: Symbol.for("IHealthMilestoneService")
};
